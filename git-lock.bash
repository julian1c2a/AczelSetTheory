...
#   bash git-lock.bash unlock AczelSetTheory/Module.lean   # temporary unlock (blocked if frozen)
#   bash git-lock.bash freeze AczelSetTheory/Module.lean   # permanent freeze (Complete -> Frozen)
#   bash git-lock.bash thaw   AczelSetTheory/Module.lean --confirm  # emergency unfreeze
