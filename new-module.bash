...
# Updates:  AczelSetTheory.lean             (adds import line)
# Unlocks:  AczelSetTheory.lean for editing (re-locks after update)
...
# e.g. "Algebra/Ring" -> file: AczelSetTheory/Algebra/Ring.lean
#                      -> import: AczelSetTheory.Algebra.Ring
#                      -> namespace: AczelSetTheory.Algebra.Ring
...
sed \
    ...
    -e "s/AczelSetTheory\.ModuleName/${NAMESPACE_NAME}/g" \
    -e "s/import AczelSetTheory\.CSets/import ${PROJECT_NAME}.CSets/" \
...
if grep -Fqx "$IMPORT_LINE" "$ROOT_FILE" 2>/dev/null; then
    ...
    # Add import to root file (create if missing)
