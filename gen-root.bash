#!/bin/bash
# gen-root.bash — Regenerate root AczelSetTheory.lean with all module imports
#
# Usage: bash gen-root.bash
#
# Scans AczelSetTheory/ for all .lean files (excluding _template.lean),
# sorts them, and rewrites AczelSetTheory.lean with the full import list.
...
while IFS= read -r FILE; do
    ...
    # Convert file path to import name: AczelSetTheory/Foo/Bar.lean -> AczelSetTheory.Foo.Bar
    REL="${FILE#${MODULE_DIR}/}"
    REL="${REL%.lean}"
