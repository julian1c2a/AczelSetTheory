...
| **M4B** | ADR-014 (no HFInt) **+** representante canónico único para `ℤ₀` | `DECISIONS.md` (ADR-014), `Integers/Canonical.lean` | M1B | 1 sesión |
...
### 4.4 M4B — ADR-014 (no HFInt) + representante canónico único
