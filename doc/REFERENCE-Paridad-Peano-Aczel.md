...
| `GroupTheory/Sylow/Sylow.lean` | 🟡 | — | Teoremas de Sylow (Sylow I-III). **Pendiente** — requiere `cauchy_minimal` (Cauchy) + `card_sylow_subgroup` (Lagrange). Prerrequisito: McKay D.4.D ✅ (completado 2026-05-29). |
